...
function next(current, next = null, prev = null) {
    //change user input to be auto-capitalized
    current.value = current.value.toUpperCase();
    //if something inside input, reroute
    if (current.value.length >= current.maxLength) {
        document.getElementById(next).focus();
        return;
    //nothing inside, so do a sanity check and then go back
...
function test(event, next) {
    if (event.keyCode == 13) {
        var rawOne = document.getElementById("letter_one");
        var one = document.getElementById("letter_one").value.toUpperCase();
        var rawTwo = document.getElementById("letter_two");
        var two = document.getElementById("letter_two").value.toUpperCase();
        var rawThree = document.getElementById("letter_three");
        var three = document.getElementById("letter_three").value.toUpperCase();
        var rawFour = document.getElementById("letter_four");
        var four = document.getElementById("letter_four").value.toUpperCase();
        var rawFive = document.getElementById("letter_five");
        var five = document.getElementById("letter_five").value.toUpperCase();
